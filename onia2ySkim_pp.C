...
static const long MAXTREESIZE = 12000000000;
		 ...
		 ) 
{
  ...
  if (fileID == kPPDATA) {
    fname = "/home/samba.old/UpsilonAnalysis/tempfiles/Upsilon_pPb/data/OniaTree_DoubleMu_Run2015E-PromptReco-v1_Run_262157_262328_noCUT_TRKMU.root";
    mytree->Add(fname.Data());
  }
  if (fileID == kPADATA) {
    fname = "/home/samba.old/UpsilonAnalysis/tempfiles/Upsilon_pPb/data/OniaTree_PromptAOD_pPb2013_210498-211631_GR_P_PU1_nocut.root"; // in lxplus
    mytree->Add(fname.Data());
  }
  ...
  if (fileID == kPADATA) {
    ...
    newfile = new TFile(Form("skimmedFiles/yskimPA_%s_%s_%s.root",fdimusign.Data(), getDayAndTime().Data(), skimVersion.Data() ),"recreate");   
  }
  else if (fileID == kAADATA) { 
  ...
  ULong64_t       Reco_QQ_trig[1000];   //[Reco_QQ_size]
  ...
  //  muon id 
  Int_t           Reco_QQ_mupl_nTrkHits[1000];   //[Reco_QQ_size]
  Int_t           Reco_QQ_mumi_nTrkHits[1000];   //[Reco_QQ_size]
  ...
  Float_t         Reco_QQ_mupl_normChi2_global[1000];   //[Reco_QQ_size]
  Float_t         Reco_QQ_mumi_normChi2_global[1000];   //[Reco_QQ_size]
  ...
  Int_t           Reco_QQ_mupl_nMuValHits[1000];   //[Reco_QQ_size]
  Int_t           Reco_QQ_mumi_nMuValHits[1000];   //[Reco_QQ_size]
  ...
  Int_t           Reco_QQ_mupl_StationsMatched[1000];   //[Reco_QQ_size]
  Int_t           Reco_QQ_mumi_StationsMatched[1000];   //[Reco_QQ_size]
  ...
  Float_t         Reco_QQ_mupl_dxy[1000];   //[Reco_QQ_size]
  Float_t         Reco_QQ_mumi_dxy[1000];   //[Reco_QQ_size]
  Float_t         Reco_QQ_mupl_dxyErr[1000];   //[Reco_QQ_size]
  Float_t         Reco_QQ_mumi_dxyErr[1000];   //[Reco_QQ_size]
  ...
  Float_t         Reco_QQ_mupl_dz[1000];   //[Reco_QQ_size]
  Float_t         Reco_QQ_mumi_dz[1000];   //[Reco_QQ_size]
  Float_t         Reco_QQ_mupl_dzErr[1000];   //[Reco_QQ_size]
  Float_t         Reco_QQ_mumi_dzErr[1000];   //[Reco_QQ_size]
  ...
  Int_t           Reco_QQ_mupl_nTrkWMea[1000];   //[Reco_QQ_size]
  Int_t           Reco_QQ_mumi_nTrkWMea[1000];   //[Reco_QQ_size]
  ...
  Bool_t          Reco_QQ_mupl_TMOneStaTight[1000];   //[Reco_QQ_size]
  Bool_t          Reco_QQ_mumi_TMOneStaTight[1000];   //[Reco_QQ_size]
  ...
  Int_t           Reco_QQ_mupl_nPixWMea[1000];   //[Reco_QQ_size]
  Int_t           Reco_QQ_mumi_nPixWMea[1000];   //[Reco_QQ_size]
  ...
  Int_t           Reco_QQ_sign[1000];   //[Reco_QQ_size]
  ...
  Int_t           Reco_QQ_mupl_nPixValHits[1000];   //[Reco_QQ_size]
  ...
  Int_t           Reco_QQ_mumi_nPixValHits[1000];   //[Reco_QQ_size]
  ...
  Float_t         Reco_QQ_mupl_ptErr_global[1000];   //[Reco_QQ_size]
  ...
  Float_t         Reco_QQ_mumi_ptErr_global[1000];   //[Reco_QQ_size]
  ...
  /////////////////////////////////////////
  Int_t           Gen_QQ_size;
  Int_t           Gen_QQ_type[1000];   //[Gen_QQ_size]
...
/*  RooRealVar* HFplus4   = new RooRealVar("HFplus4","", 0,1000,"");
  RooRealVar* HFminus4   = new RooRealVar("HFminus4","", 0,1000,"");
  RooRealVar* HFplus   = new RooRealVar("HFplus","", 0,1000,"");
  RooRealVar* HFminus   = new RooRealVar("HFminus","", 0,1000,"");
  RooRealVar* HF   = new RooRealVar("HF","", 0,1000,"");
  RooRealVar* ntracks   = new RooRealVar("ntracks","", 0,1000,"");
...
////////////////////////////////////////////////////////////////////////
  ...
  */  
  ...
  //for(int iev=5558620; iev<nevt ; ++iev)
  {
