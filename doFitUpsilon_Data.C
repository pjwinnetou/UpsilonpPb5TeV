#include <iostream>
#include "/home/deathold/work/CMS/analysis/Upsilon_RpA/pPb5TeV/rootFitHeaders.h"
#include "/home/deathold/work/CMS/analysis/Upsilon_RpA/pPb5TeV/commonUtility.h"
...
#include "TArrow.h"
#include "TFile.h"
#include "/home/deathold/work/CMS/analysis/Upsilon_RpA/pPb5TeV/cutsAndBin.h"
#include "/home/deathold/work/CMS/analysis/Upsilon_RpA/pPb5TeV/PsetCollection.h"
#include "/home/deathold/work/CMS/analysis/Upsilon_RpA/pPb5TeV/CMS_lumi.C"
#include "/home/deathold/work/CMS/analysis/Upsilon_RpA/pPb5TeV/tdrstyle.C"
#include "/home/deathold/work/CMS/analysis/Upsilon_RpA/pPb5TeV/SONGKYO.h"
       ...
       bool fixParameters=0  )
{
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 1.971 , 1.512, 3.381);
  ...
  RooRealVar n1s_1("n1s_1","power order", 2.035 , 1.204, 3.358);
  ...
  RooRealVar err_sigma("#sigma","err_sigma", init_sigma, 0,23);
...
*/
  ...
  //TFile* outf = new TFile("PAS_fitresults_upsilon_DoubleCB.root","recreate");
  TFile* outf = new TFile(Form("PAS_fitresults_upsilon_DoubleCB_5TeV_%s.root",kineLabel.Data()),"recreate");
  outh->Write();
  //c1->SaveAs("PAS_fitresults_upsilon_DoubleCB.pdf");
  c1->SaveAs(Form("PAS_fitresults_upsilon_DoubleCB_5TeV_%s.pdf",kineLabel.Data()));
  c1->SaveAs(Form("PAS_fitresults_upsilon_DoubleCB_5TeV_%s.png",kineLabel.Data()));
  c1->Write();
  ws->Write();
